                                                    ...
                                                    foreach ($lpx as $key => $value) {
                                                        ...
                                                        if(array_key_exists("codigo_coopidrogas",$value) && $value["codigo_coopidrogas"]!==NULL){
                                                            $d=DB::table("productos")
                                                                    ->where("codigo_producto","LIKE",$value["codigo_coopidrogas"])
                                                                    ->orwhere("codigo_distribuidor","LIKE",$value["codigo_coopidrogas"])
                                                                    ->get();
                                                                ...
                                                                if(count($d)>0){
                                                                            ...
                                                                            if(array_key_exists("nuevo_codigo_distribuidor",$value) && $value["nuevo_codigo_distribuidor"]!==NULL){
                                                                                      $editar[$i]["codigo_distribuidor"]=$value["nuevo_codigo_distribuidor"]; 
                                                                            }    

                                                                            if(array_key_exists("nuevo_codigo_venta",$value) && $value["nuevo_codigo_venta"]!==NULL){
                                                                                      $editar[$i]["codigo_producto"]=$value["nuevo_codigo_venta"]; 
                                                                            }   
